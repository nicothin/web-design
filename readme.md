...
**Не используйте ![маркерное выделение текста](/img/marker-text.png "маркерное выделение текста")**, если предполагается перенос строк (а это случится обязательно, если проект делается с адаптивностью). Правый и левый внутренние отступы возможны только в начале и в конце какого-либо элемента, при переносе они будут нулевыми. Оборачивание же каждого слова в отдельный тег добавит много боли контент-менеджеру.
