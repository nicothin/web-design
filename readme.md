...
**Не накладывайте на векторные изображения в PSD-макетах корректирующие слои**. C высокой вероятностью это приведёт к невозможности использования такой векторной графики.

**Не накладывайте на векторные изображения в PSD-макетах маски**. C чуть менее чем стопроцентной вероятностью это сделает использование такой векторной графики невозможным, придется растрировать.
